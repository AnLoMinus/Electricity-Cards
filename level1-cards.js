// קלפי רמה 1: יסודות החשמל (קלפים 1-10)
const level1Cards = {
  1: {
    title: "מהו חשמל?",
    icon: "⚡️",
    ...
    content: `
            <div class="card-content">
                ...
                <div class="inspiration-quote">
                    <h4>✨ משפט השראה</h4>
                    <div class="quote-box">
                        <p><em>"החיבור הטורי מלמד אותנו שאנחנו עובדים יחד בשרשרת, כולנו חשובים באותה מידה"</em></p>
                    </div>
                </div>
            </div>
        `,
    ...
    content: `
            <div class="card-content">
                ...
                <div class="inspiration-quote">
                    <h4>✨ משפט השראה</h4>
                    <div class="quote-box">
                        <p><em>"החיבור המקביל מלמד אותנו שאנחנו נותנים לכל אחד דרך משלו, כולם יכולים להצליח"</em></p>
                    </div>
                </div>
            </div>
        `,
    ...
    content: `
            <div class="card-content">
                ...
                <div class="inspiration-quote">
                    <h4>✨ משפט השראה</h4>
                    <div class="quote-box">
                        <p><em>"המוליכים מלמדים אותנו שאנחנו בונים דרכים טובות, כולם רוצים לעבור בהן"</em></p>
                    </div>
                </div>
            </div>
        `,
...
if (typeof module !== "undefined" && module.exports) {
  module.exports = level1Cards;
} else {
  window.level1Cards = level1Cards;
  console.log("רמה 1 נטענה בהצלחה - 10 קלפים זמינים");
}
